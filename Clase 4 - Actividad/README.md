...
| Archivo | Descripción |
| ------- | ----------- |
| [`noticia.html`](./noticia.html) | Documento HTML semántico (`header`, `main`, `article`, `section`, `figure`, `aside`, `footer`, etc.). |
| [`styles.css`](./styles.css) | Estilos mínimos: selectores de elementos (`body`, `main`, `figure`, combinadores como `body > header`). |
...
INICIO
  ...
  CREAR styles.css breve (layout legible y cabecera simple, sin muchas clases)
